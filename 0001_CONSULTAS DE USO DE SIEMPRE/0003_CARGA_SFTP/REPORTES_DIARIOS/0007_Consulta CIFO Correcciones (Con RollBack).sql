------------------VERSION 2 SEBAS
with canceladas as (select coop.ifoliocomercio
...
from COMERCIOCONSULTAS.operaciones o
         ...
         left join comercio.logventadetalle lvd1
                   on lvd1.uidlogventa = lv.uidlogventa and lvd1.sestatus = 'OPERACIÓN GUARDADA'
         left join comercio.logventadetalle lvd2
                   on lvd2.uidlogventa = lv.uidlogventa and lvd2.sestatus = 'SALDO PROTEGIDO'
         left join comercio.logventadetalle lvd3
                   on lvd3.uidlogventa = lv.uidlogventa and lvd3.sestatus = 'OPERACIÓN DETALLE GUARDADA'
         left join comercio.logventadetalle lvd4
                   on lvd4.uidlogventa = lv.uidlogventa and lvd4.sestatus = 'CONFIRMACIÓN DE SALDO PROTEGIDO'
