...
SELECT * FROM SINCRONIZADOR.AJUSTEDEB WHERE UIDDETALLESINCRONIZADOR IN ('0e18ffe9-74be-48cd-b9cf-ae1e7f87cbdf');
...
--SECCION DE REGISTROS ERROR MAS LOS REGISTROS BUENOS TOMANDO PRIMERO LOS DE ERROR Y LUEGO LOS BUENOS DE FECHAS INICIALES CON REGISTROS SIN ERROR
        ...
        SELECT 
            ...
            TO_DATE('12-06-2025', 'DD-MM-YYYY') + (B.DTFECHAOPERACION - TRUNC(B.DTFECHAOPERACION)) AS NVAFECHAPROCESAR,
            CASE 
