...
AND m.DTFECHAOPERACION >= '05/10/25 00:00:00'
and m.DTFECHAOPERACION <  '06/10/25 00:00:00'
;
...
--PAGOS CODI
SELECT trunc(o.DTFECHA), count(0) as trxs, sum(o.dmonto) as importe
...
LEFT JOIN MONEDEROCOMANDOS.MOVIMIENTOSESTADOSDECUENTA m ON m.UIDMONEDERO = o.UIDMONEDERO AND m.UIDOPERACION = oCodi.UIDPAGOCODI AND m.SEMISOR = 'APP'
WHERE 
o.DTFECHA >= TO_DATE('01-09-2025', 'DD-MM-YYYY') and o.DTFECHA <  TO_DATE('01-10-2025', 'DD-MM-YYYY')
AND oCodi.SESTATUSCODI = 'Exitoso'
AND o.BPAGADO = 1
AND o.IOPCION_PAGO = 4
AND m.UIDOPERACION IS not NULL
group by trunc(o.DTFECHA)
;    
