...
select * from app.usuario where stelefono = '9994145195';--0f6747c1-69c1-47a4-8bee-e4fd67ac5415
...
SELECT * FROM APPMONEDEROCOMMAND.TARJETAUSUARIO  where UIDUSUARIO = '8be3bda4-3516-4b89-a71a-05c63dbfb38a';
...
select * from app.usuario where stelefono = '9992150300';
select * from app.usuario where uidusuario = 'd42c62d0-d86d-45ba-a21a-d69d06d5a049';
SELECT * FROM APPMONEDEROQUERY.TARJETAUSUARIO where snumerotarjeta ='5000000000965240';
SELECT * FROM APPMONEDEROCOMMAND.TARJETAUSUARIO where snumerotarjeta ='5000000000965240';
...
select * from APPMONEDEROCOMMAND.TARJETAUSUARIO app where uidusuario = '83c6f7bc-0ce2-4949-901d-a1f1a1d799da';
select * from APPMONEDEROQUERY.TARJETAUSUARIO app where uidusuario = '83c6f7bc-0ce2-4949-901d-a1f1a1d799da';
...
select * from app.usuario where stelefono = '9997827667';
select * from app.usuario where stelefono = '9993540787';
    select * from credencializacion.tarjetas where iNumeroTarjeta = '5000000000188812';
select * from credencializacion.usuariostarjetas where sfolioexternotarjeta = '5000000000188812';
select * from app.usuario where scorreo = 'ejms_jemc@hotmail.comRams';
select * from app.usuario where scorreo = 'ejms_jemc@hotmail.com';
select * from app.usuario where UIDUSUARIO = '83c6f7bc-0ce2-4949-901d-a1f1a1d799da';
------------------
...
-----------------
select * from app.usuario where stelefono = '9995821221';
select * from app.usuario where stelefono = '9996702508';
select * from app.usuario where scorreo = 'charlienovelo57@gmail.com';
select * from app.usuario where scorreo = 'cn9162941@gmail.com';
...
-----------------
select * from pagos.usuario where scorreo = 'freddy_1198@hotmaail.com';
SELECT * FROM APPMONEDEROQUERY.TARJETAUSUARIO where snumerotarjeta ='5000000000642488';
SELECT * FROM APPMONEDEROCOMMAND.TARJETAUSUARIO where snumerotarjeta ='5000000000642488';
SELECT * FROM APPMONEDEROQUERY.TARJETAUSUARIO where uidusuario ='07adc7c8-9175-4208-a5af-606c5fbb65a8';
SELECT * FROM APPMONEDEROCOMMAND.TARJETAUSUARIO where uidusuario ='07adc7c8-9175-4208-a5af-606c5fbb65a8';
...
select * from monederoconsultas.estadodecuenta where uidmonedero = '8f172a74-c032-4329-adb6-179bb0b2b234';
