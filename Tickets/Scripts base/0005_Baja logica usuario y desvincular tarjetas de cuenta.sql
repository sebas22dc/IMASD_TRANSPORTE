...
SELECT * FROM APP.USUARIO                         WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
SELECT * FROM APPMONEDEROCOMMAND.USUARIO          WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
SELECT * FROM APPTICKETS.USUARIO                  WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
SELECT * FROM PAGOS.USUARIO                       WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';

---UPDATES
UPDATE APP.USUARIO SET BACTIVO=0,BBAJA=1                         WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
UPDATE APPMONEDEROCOMMAND.USUARIO SET BACTIVO=0,BBAJA=1          WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
UPDATE APPTICKETS.USUARIO SET BACTIVO=0,BBAJA=1                  WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
UPDATE PAGOS.USUARIO SET BACTIVO=0,BBAJA=1                       WHERE UIDUSUARIO='594e8f19-6adc-4024-afa5-60bec76096d8';
...
AND t.BACTIVO = 1 AND usu.UIDUSUARIO = '594e8f19-6adc-4024-afa5-60bec76096d8'
);
commit;
...
AND USU2.BBAJA = 1
AND AM.BACTIVO = 1
AND USU2.UIDUSUARIO = '594e8f19-6adc-4024-afa5-60bec76096d8' --and am.snumerotarjeta = 5000000000593414
);
commit;