...
JOIN SINCRONIZADOR.MONEDERO SM on XW.iNumeroTarjeta = SM.INUMEROTARJETA ---> directris de join para determinar que los ltcs son iguales
  WHERE 
 1=1
   AND E.DSALDO <= -12 
 --AND E.SESTATUS = 'ACTIVO'
  -- AND E.UIDMONEDERO = 'dc94aea1-d497-4ef9-b9fb-b16d8d9bc044'
 AND E.INUMMONEDERO = 1000000000981115 --> cuando sea por lote esto se debe de quitar MUCHO CUIDADO CON ESTE DURANTE PRUEBAS, SIEMPRE DEBE TENER UN DATO DEL NUMERO DE MONEDERO
