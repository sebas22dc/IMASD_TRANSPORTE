...
WHERE 1=1
AND t.BACTIVO = 1 AND t.snumerotarjeta = '5000000001197159'
)
;commit;
...
1=1
AND AM.BACTIVO = 1
AND am.snumerotarjeta = '5000000001197159' --and am.snumerotarjeta = 5000000000593414
);
commit;
