-- 19125	
-- 5000000000341762
-- 		cynthiacanche252@gmail.com	
--         amayranycanche616@gmail.com	
--         9994960757
--         	9994984408
--             	Desvincular tarjeta			Proceso	Italo			Documento
...
WHERE 1=1
AND t.BACTIVO = 1 AND t.snumerotarjeta = '5000000000341762'
);
commit;
...
1=1
AND AM.BACTIVO = 1
AND am.snumerotarjeta = '5000000000341762' --and am.snumerotarjeta = 5000000000593414
);
commit;