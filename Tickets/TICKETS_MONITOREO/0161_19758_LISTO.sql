-- -- 19758	
-- 5000000000612091		
-- mayrachlop@hotmail.com	
--  mayrachuillopez@gmail.com 
--  	9991040276		
--     Desvincular/Vincular tarjeta			Proceso	Italo
...
WHERE 1=1
AND t.BACTIVO = 1 AND t.snumerotarjeta = '5000000000612091'
);
commit;
...
1=1
AND AM.BACTIVO = 1
AND am.snumerotarjeta = '5000000000612091' --and am.snumerotarjeta = 5000000000593414
);
commit;
