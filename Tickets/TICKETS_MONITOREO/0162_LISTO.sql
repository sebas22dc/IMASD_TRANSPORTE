-- -- 20350	
-- 5000000000679061						
-- No se refleja recarga en cuenta del usuario, pero sí aparece 
-- en las transacciones del comercio Willys
-- 	"Recarga de 50 pesos no reflejada realizada en establecimiento Super Willys

-- -- Marcos Fernando Sandoval palma

-- -- 9996411210

-- -- mfsandovalp@gm

-- -- 5000 0000 0067 9061"		Proceso	Mercy		
...
--COMMIT; 
AND snumeromonedero = '1000000000272138';
 COMMIT;
...
AND M.ifoliomovimiento = 11026389
...
where uidmonedero = (select uidmonedero from credencializacion.tarjetas where  inumeromonedero = '1000000000272138');
----------------------------------------
