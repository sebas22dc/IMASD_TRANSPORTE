-- 20516	5000000000589378						"En Comercios/Monitor de operaciones, se observa el registro por Recarga de saldo Monto abierto de $100.00 realizado en PROVEEDORA DEL PANADERO S.A. DE C.V. (DUNOSUSA) con Folio 11026366 y fecha/hora 17/08/2025 - 12:58

-- En Gestión de monederos/Movimientos, se observa que NO existe el abono de $100.00 por Venta de saldo de PROVEEDORA DEL PANADERO S.A. DE C.V., con folio 11026366 en los movimientos del monedero 1000000000585317"	"Usuario reporta que su recarga de $100.00 realizada en establecimiento no se vio reflejada en su tarjeta
-- Erik Alejandro Balam chi
-- 9994537678
-- 5000 0000 0058 9378
-- erikalejandro1578@gmail.com"	No se reflejo el abono en los movimientos del número de monedero 1000000000585317 de la tarjeta 5000000000589378,	Proceso	Pedro			Documento	
...
--COMMIT; 
AND snumeromonedero = '1000000000585317';
 COMMIT;
...
AND M.ifoliomovimiento = 10365443
...
where uidmonedero = (select uidmonedero from credencializacion.tarjetas where  inumeromonedero = '1000000000585317');
----------------------------------------
